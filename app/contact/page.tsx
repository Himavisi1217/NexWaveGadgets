      ...
      <div className="container mx-auto py-16 flex flex-col items-center">
        <div className="bg-background/80 rounded-2xl shadow-2xl p-10 max-w-md w-full text-center border border-purple-500">
          ...
          <form className="space-y-4 text-left">
            <input type="text" placeholder="Your Name" className="w-full border-2 border-blue-400 rounded px-3 py-2 bg-background/90 text-foreground focus:ring-2 focus:ring-blue-500" required />
            <input type="email" placeholder="Your Email" className="w-full border-2 border-blue-400 rounded px-3 py-2 bg-background/90 text-foreground focus:ring-2 focus:ring-blue-500" required />
            <textarea placeholder="Your Message" className="w-full border-2 border-purple-400 rounded px-3 py-2 bg-background/90 text-foreground focus:ring-2 focus:ring-purple-500" rows={4} required />
